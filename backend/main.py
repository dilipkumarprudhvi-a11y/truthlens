...
# ─── CORS ────────────────────────────────────────────────────
# Allow ALL origins so any deployed frontend can connect
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
# ─── DATABASE ────────────────────────────────────────────────
# Use /tmp for ephemeral cloud deployments (Render, Railway, etc.)
# Falls back to local path for development
if os.environ.get("ENV") == "production" or not os.path.exists("./"):
